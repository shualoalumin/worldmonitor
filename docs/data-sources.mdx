...
| `semi` | `live-news` | Reuters Semiconductors; Bloomberg Chips; Nikkei Asia Tech; DigiTimes; Tom’s Hardware |
| `semi` | `semiconductors` | AnandTech / Chip Design; Foundry & Nodes; Memory & Storage; Equipment Makers; EE Times |
| `semi` | `fab-capex` | Fab Construction; Capex & Guidance; Chip Subsidies; Packaging & Test Capacity |
| `semi` | `export-controls` | Export Controls; Chip Sanctions; Tariffs & Trade Rules; Taiwan & Korea Policy |
| `semi` | `chip-materials` | Wafers & Substrates; Critical Chip Inputs; HBM & Advanced Memory; Chip Logistics |
